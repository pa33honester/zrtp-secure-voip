...
import org.sipdroid.media.ZrtpCallback;
...
public abstract class ZrtpUserCallback {
    ...
    public abstract boolean sendDataZRTP(byte[] data);

    public abstract int activateTimer(int time);

    public abstract int cancelTimer();

    public abstract void sendInfo(ZrtpCodes.MessageSeverity severity, EnumSet<?> subCode);

    //public abstract boolean srtpSecretsReady(ZrtpSrtpSecrets secrets, EnableSecurity part);

    //public abstract boolean srtpSecretsReady(ZrtpSrtpSecrets secrets, ZrtpCallback.EnableSecurity part);

    //public abstract void srtpSecretsOff(ZrtpCallback.EnableSecurity part);

    public abstract void srtpSecretsOn(String c, String s, boolean verified);

    public abstract void handleGoClear();
    ...
    public abstract void zrtpNegotiationFailed(String reason);
    ...
    public abstract void zrtpAskEnrollment(String info);

    public abstract void zrtpInformEnrollment(String info);

    public abstract void zrtpSignSAS(byte[] sasHash);

    public abstract boolean zrtpSASSigned(byte[] sasHash);
